...
**Migration mechanics — captured 2026-05-14 18:53 MST, 5 minutes after the initial rebrand notice** (full broadcast: `evidence/bonchat/hqiex-migration-procedure-broadcast-2026-05-14.txt`). Operators issued a follow-up broadcast specifying the migration procedure inside the **BG-015 group meeting**. Four operationally-significant additions:

1. **Operator-account handle rotation: Elena03 → Elena2026.** Verbatim: *"Add the following account using your current Bonchat account: Elena2026 (We will be temporarily suspending the use of the Elena03 assistant account)."* Elena03 — documented throughout April-May as the operator's intake/onboarding gateway (see §2.4) — is being formally retired in favor of Elena2026 as part of the platform pivot. **Both handle histories on BonChat (`bonchat.live`) are now critical subpoena targets**, including the May 14 transition messages: every BonChat account that adds Elena2026 in the May 14–18 window is by operator design a stranded DSJ victim — making Elena2026's contact list a complete enumeration of the active migrating-victim cohort.

2. **Operator data-correlation step.** Victims are instructed to send **both** their original DSJ account ID **and** their new HQI account ID to Elena2026 manually before any "fund transfer" will be processed. This is the mapping table operators need to bridge the existing victim database (with deposit history, MLM rank, paid-vs-unpaid rectification-fee status) onto the HQIEX platform. Once correlated, the operators can (a) display "transferred" balance figures on HQIEX matching what DSJ showed — theatrical only, no on-chain asset movement — and (b) selectively "honor" balances for victims worth continued extraction while dropping low-value or already-fully-extracted accounts.

3. **Manufactured-urgency deadline: May 14–18 (4-day window).** Verbatim: *"the migration process will be completely stopped after May 18th; members who do not complete the process will be considered to have voluntarily given up."* Explicit forfeiture language. Functions: (a) maximize $100 deposit conversion before regulator/media coverage, (b) supply a future cover story for non-refunds. Legitimate platforms do not erase member balances after 4 days of migration. The deadline language is itself a wire-fraud predicate.

4. **BG-015 cohort segmentation confirmed.** *"In the BG-015 group meeting, I announced…"* — the operators segment victims into numbered groups (BG-001 → BG-N), each with its dedicated upline running broadcasts. `CBK806SRN400` funnels the BG-015 cohort into a single HQIEX commission tree, preserving upline-tree continuity for the new platform. The previously-captured `BG-015 Wealth Sharing Investment Group` channel naming (§2.4) is consistent with this cohort structure.

The $100 framing is identical to the 12 % rectification-fee framing in the April-May broadcasts: *"the deposited $100 will remain in your account and belong to you personally."* The rectification-fee balances were never honored. Per the on-chain evidence below (§2.2.1, `wallet/WALLET_FORENSICS.md`), there is no scenario under which any DSJ balance materializes on HQIEX. No mention is made of crediting victims who already paid the 12 % rectification fee against the new $100 activation — confirming a **double-extraction**, consistent with how recovery scams typically work.
...
| 2022-07 → 2026 | **New Era Web** (and successor "**New Era Copy Trading**") | **Operator-family-confirmed:** `neweraweb.com` registered via **Gname.com Pte. Ltd.** (same Singapore registrar fingerprint as the entire BG/DSJ rotation fleet — see §2.1). WA DFI fraud alert issued 2026-02-03: `dfi.wa.gov/alerts/alleged-cryptocurrency-trading-platform-new-era-web-appears-be-engaged-fraud`. Recruitment via romance-scam pattern (LinkedIn → WhatsApp), promoter named **Thuy-Trang Pham** (per WA DFI). Single victim reported $850,000 loss. **Same advance-fee playbook as BG/DSJ:** manufactured "money laundering suspicion" requiring victim to send $400,000 additional to "unlock" funds (cf. the 12 % rectification-fee mechanism documented in §4.7). A successor brand named "**New Era Copy Trading**" was publicly flagged on 2026-05-07 (request to ZachXBT for investigation); the specific successor URL has not yet been captured. The Pham → New Era Web → New Era Copy Trading thread is a parallel operator branch targeting **professionals/executives via LinkedIn** rather than the diaspora-community pig-butchering channel of BG/DSJ. **Same operator network, different victim cohort, same playbook.** |
