...
- **Operator account handles (live capture 2026-05-05):**
  ...
  - The `03` suffix shared across both handles is suggestive of an internal numbered-persona scheme. Whether either account is operated by the named on-camera figure personally or by other operators using their names is unresolved — but brand cohesion is direct: the front-man identities are also the broadcast-channel identities.
