...
The platform branding personas — "**Professor Stephen Beard**" (claimed founder, gives daily "signals") and "**Joseph Smith**" (claimed COO) — are not who they claim to be. **Stephen Beard is a real person who appears recurrently in live Zoom meetings with victim recruits** (eyewitness corroboration). This rules out the AI-synthesis hypothesis and rules out the naive "white-monkey job" interpretation as well: a recurring live appearance schedule means active, willing coordination with operators. He is most plausibly a **paid Western spokesperson** — possibly originally hired via the Chinese "白工" (paid foreigner-prop) channel, but the recurring Zoom cadence makes him a **knowing participant**, not an unwitting one. He should therefore be treated as a **target / co-conspirator candidate**, not a mere witness. Investigators should reverse-image-search his face for prior commercial appearances and subpoena recordings of past BGW Zoom sessions for direct-evidence statements. The actual technical operation relied on freelance/commissioned developers in India and possibly elsewhere, with the source code briefly exposed on public GitHub.
...
- **"Professor Stephen Beard"** — claimed BGW founder, gives daily "trading signals" (delivered exclusively via BonChat per §2.4). No biographical identity verifiable outside promo materials. Referenced by name in the **FCA UK warning** (May 2025).
  - **Real person, knowing participant.** Eyewitness corroboration confirms he appears live in BGW Zoom meetings with victim recruits on a recurring schedule. That cadence rules out: (a) AI-generated identity (earlier report draft was wrong about this — retracted), and (b) the naive "白工" / "white-monkey job" interpretation (a one-shot foreigner-prop hire would not have a sustained Zoom presence).
  - **Most plausible profile:** a Western spokesperson initially recruited through Chinese paid-foreigner-prop channels who has since become an active, paid front-man — coordinating live with operators, reading scripts to victim audiences, and lending his real face and voice to legitimacy theater. He is recurringly visible; he is therefore knowingly participating.
  - **Treatment in any filing:** target / co-conspirator candidate, **not** witness. Note: "Stephen Beard" the on-camera name may be a stage / pseudonym; his real legal identity is the open question.
  - **Investigative leads on this persona:**
    - Reverse-image-search his face across stock-footage sites, talent-agency rosters, and other Chinese-promoter materials — the same face often shows up across multiple "white-foreigner-prop" gigs.
    ...
    - Subpoena Zoom for the host accounts that scheduled BGW recurring meetings — those accounts are tied to real billing emails / phones.
- **"Joseph Smith"** — claimed DSJ Exchange COO. Promo video: `youtube.com/watch?v=dJ9A87PSJhM`. No verifiable identity. Same "real person, paid front-man" pattern likely applies pending Zoom-presence corroboration.
